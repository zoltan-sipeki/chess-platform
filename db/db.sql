...
GRANT SELECT ON * TO 'api';
GRANT UPDATE ON * TO 'api';
GRANT DELETE ON * TO 'api';
GRANT INSERT ON * TO 'api';
GRANT SELECT ON * TO 'chat';
GRANT UPDATE ON * TO 'chat';
GRANT DELETE ON * TO 'chat';
GRANT INSERT ON * TO 'chat';
GRANT SELECT ON * TO 'chess';
GRANT UPDATE ON * TO 'chess';
GRANT DELETE ON * TO 'chess';
GRANT INSERT ON * TO 'chess';